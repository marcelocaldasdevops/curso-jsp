<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<head>
    <title>Curso JSP - Marcelo Caldas </title>
    ...
    <!--[if lt IE 10]>
      ...
      <meta name="description" content="Curso JSP, esse e um projeto do curso Jdev Treinamento." />
      <meta name="keywords" content="JSP, JAVA, Dev.  " />
      <meta name="author" content="Marcelo caldas" />
      <!-- Favicon icon -->
