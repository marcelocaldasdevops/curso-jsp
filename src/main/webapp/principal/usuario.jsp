														...
														<form class="form-material" enctype="multipart/form-data"
															...
															<div class="form-group form-default input-group mb-4">
																<div class="input-group-prepend">
																	...
																	<c:if
																		test="${modolLogin.fotouser == '' || modolLogin.fotouser == null }">
																		<img alt="Imagem User" id="fotoembase64"
																			src="assets/images/Deafult-Profile-Pitcher.png"
																			width="70px">
																	</c:if>
																</div>
															...
															<div class="form-group form-default form-static-label">
																<input onblur="pesquisarCep()" type="text" name="cep"
																	id="cep" class="form-control" required=""
															...
															<div class="form-group form-default form-static-label">
																<input type="text" name="logradouro" id="logradouro"
																	...
																	class="form-bar"></span> <label
																	class="float-label">Logradouo:</label>
															</div>
															<div class="form-group form-default form-static-label">
															...
															<div class="form-group form-default form-static-label">
																<input type="radio" name="sexo" value="MASCULINO"
																	checked="checked" <%ModelLogin modelLogin = (ModelLogin) request.getAttribute("modolLogin");
if (modelLogin != null && modelLogin.getSexo().equals("MASCULINO")) {
	out.print(" ");
	out.print("checked=\"checked\"");
	out.print(" ");
}%>>
																<span></span> <label>Masculino:</label> <input
																	type="radio" name="sexo" value="FEMININO" <%modelLogin = (ModelLogin) request.getAttribute("modolLogin");
	...
	out.print(" ");
															...
															<div class="form-group form-default form-static-label">
																<select class="form-control"
																	...
																	<option value="ADMIN" <%modelLogin = (ModelLogin) request.getAttribute("modolLogin");
...
if (modelLogin != null && modelLogin.getPerfil().equals("AUXILIAR")) {
	...
	out.print(" ");
															...
															<button type="button" class="btn btn-secondary"
																data-toggle="modal"
																data-target="#exampleModalUser">Pesquisar
															</button>
														</form>
													</div>
												</div>
													...
													<c:forEach items='${modelLogins}' var='ml'>
														<tr>
															...
															<td><a class="btn btn-success"
																	href="<%= request.getContextPath() %>/ServLetUsuarioController?acao=buscaEditar&id=${ml.id}">Ver</a>
															</td>
														</tr>
													</c:forEach>
												</tbody>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="input-group mb-3">
						<input type="text" class="form-control" placeholder="Nome" id="nomeBusca" aria-label="nome"
